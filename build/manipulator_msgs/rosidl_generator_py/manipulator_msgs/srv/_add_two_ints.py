...
class AddTwoInts_Event(metaclass=Metaclass_AddTwoInts_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<manipulator_msgs/AddTwoInts_Request, 1>',
        'response': 'sequence<manipulator_msgs/AddTwoInts_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['manipulator_msgs', 'srv'], 'AddTwoInts_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['manipulator_msgs', 'srv'], 'AddTwoInts_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from manipulator_msgs.srv import AddTwoInts_Request
    ...
    def response(self, value):
        if self._check_fields:
            from manipulator_msgs.srv import AddTwoInts_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_AddTwoInts(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'manipulator_msgs.srv.AddTwoInts')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from manipulator_msgs.srv import _add_two_ints
...
class AddTwoInts(metaclass=Metaclass_AddTwoInts):
    from manipulator_msgs.srv._add_two_ints import AddTwoInts_Request as Request
    from manipulator_msgs.srv._add_two_ints import AddTwoInts_Response as Response
    from manipulator_msgs.srv._add_two_ints import AddTwoInts_Event as Event
